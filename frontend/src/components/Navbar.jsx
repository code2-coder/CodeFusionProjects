...
const navItems = [
  ...
  },
  {
    ...
    dropdown: [
      ...
      { label: 'Healthcare & Dental', href: '/work?filter=Healthcare%20%26%20Dental' },
      { label: 'Hotels & Hospitality', href: '/work?filter=Hotels%20%26%20Hospitality' },
      { label: 'Restaurants & Cafes', href: '/work?filter=Restaurants%20%26%20Cafes' },
      { label: 'Real Estate', href: '/work?filter=Real%20Estate' },
      { label: 'Construction', href: '/work?filter=Construction' },
      { label: 'Education', href: '/work?filter=Education' },
      { label: 'Beauty & Salon', href: '/work?filter=Beauty%20%26%20Salon' },
      { label: 'Travel & Tourism', href: '/work?filter=Travel%20%26%20Tourism' },
      { label: 'Finance', href: '/work?filter=Finance' },
      { label: 'Startups', href: '/work?filter=Startups' },
      { label: 'By Project Type', isHeader: true },
      { label: 'Business Websites', href: '/work?filter=Business%20Websites' },
      { label: 'Landing Pages', href: '/work?filter=Landing%20Pages' },
      { label: 'eCommerce Stores', href: '/work?filter=eCommerce%20Stores' },
      { label: 'Web Applications', href: '/work?filter=Web%20Applications' },
      { label: 'Mobile Apps', href: '/work?filter=Mobile%20Apps' },
      { label: 'Admin Dashboards', href: '/work?filter=Admin%20Dashboards' },
      { label: 'SaaS Platforms', href: '/work?filter=SaaS%20Platforms' }
    ]
  },
